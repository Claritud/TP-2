...
const precioMaquina = components => {
    ...
    for (let component of components) {
        for (let comp of local.precios) {
            if (component === comp.componente) {
...
//         let ventaMasAltaParcial = 0; //flotante
//         // o aca hago un filter con lo que necesito obtener y depsues paso la funcion
//         //de precio de maquina 

//         for (let venta of local.ventas){

//             //falta aca la comparacion

//             if (ventaActual > ventaMasAltaParcial){
//                 ventaMasAltaParcial = ventaActual;
...
//ACA PUEDO VER DE PROBAR LO DE EL ARTISTA QUE GUARDABAMOS EL NOMBRE A MEDIDA QUE SE IBA COMPARANDO
...
//La sumás al resultado usando como parámetro lo que estás usando en el bucle for, no hay mucha manera de decirlo sin obviedades(? esto dijo peu
